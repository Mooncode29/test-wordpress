...
if ( ! function_exists( 'sp_setup' ) ) :
	...
	function sp_setup() {
		 ...
		 * If you're building a theme based on sp, use a find and replace
 ...
 */
function sp_scripts() {
	wp_enqueue_style( 'sp-style', get_stylesheet_uri() );

	wp_enqueue_script( 'sp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
